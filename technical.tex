...
the server times out. By surrounding just the first part of a computation with
\texttt{smt:with-context}, the user can insert arbitrary calls to Z3 at any
point during the computation without losing context. The details of state
preservation are hidden from the user, and from our personal experience the
resulting code tends to be quite elegant.
